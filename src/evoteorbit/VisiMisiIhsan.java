 ...
 */
public class VisiMisiIhsan extends javax.swing.JFrame {

    /**
     * Creates new form VisiMisi
     */
    public VisiMisiIhsan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/VisiMisiIhsan.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisiMisiIhsan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisiMisiIhsan().setVisible(true);
            }
        });
    }
