 ...
 */
public class VisiMisiDaffa extends javax.swing.JFrame {

    /**
     * Creates new form VisiMisi
     */
    public VisiMisiDaffa() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/VisiMisiDaffa.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisiMisiDaffa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisiMisiDaffa().setVisible(true);
            }
        });
    }
